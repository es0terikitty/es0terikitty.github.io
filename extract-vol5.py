#!/usr/bin/env python3
"""Extract Volume 5 with proper chapter splits and illustrations."""
...
CHAPTERS = [
    (12,  "Chapter 1", "The Holy Country of Millis"),
    (49,  "Chapter 2", "Paul's Story"),
    (66,  "Chapter 3", "Family Squabble"),
    (87,  "Chapter 4", "Reunited"),
    (120, "Chapter 5", "Objectives Confirmed"),
    (142, "Chapter 6", "One Week in Millishion"),
    (181, "Interlude", "Eris the Goblin Slayer"),
    (198, "Chapter 7", "To the Central Continent"),
    (223, "Interlude", "Roxy's Homecoming"),
    (233, "Extra Chapter I", "Dragon Meat, Nanahoshi-Style"),
    (245, "Extra Chapter II", "The Death of Ariel"),
]
...
def main():
    ...
    # Extract all text (get pages via form feed)
    ...
    subprocess.run(["pdfimages", "-j", pdf_path, "/tmp/mt-img/img"],
                   capture_output=True, timeout=120)

    vol_dir = os.path.join(OUTPUT_BASE, f"vol{vol_num:02d}")
    os.makedirs(vol_dir, exist_ok=True)

    # Remove old chapter dirs
    ...
    for i, (start_page, ch_type, title) in enumerate(CHAPTERS):
        ...
        for page in range(start_page, end_page + 1):
            # Add illustration if this page has one
            if page in images:
                num = images[page]
                src = None
...
"""
    ...
    # Color plates (pages before first chapter)
    ...
    # _index.md
    color_plates = sorted(f for f in os.listdir(vol_dir)
                          if f.startswith("color-plate-") and f.endswith(".jpg"))
